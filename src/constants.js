...
const setSeparators = function () {
  ;(constants.WINDOW_WIDTH = process.stdout.columns),
    (constants.FULL_SEPARATOR = '-'.repeat(constants.WINDOW_WIDTH)),
    (constants.HALF_SEPARATOR = '-'.repeat(constants.WINDOW_WIDTH / 2))
}
